...
import './styles.css'
import RecapItem from "../Recap/RecapItem";
            ...
            <div className="cart">
                <nav style={{'--bs-breadcrumb-divider': '>'}} aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item white" aria-current="page"><a href="/recap">Récapitulatif de la
                            commande &#x203A;</a>
                        </li>
                        <li className="breadcrumb-item active white" aria-current="page">Paiement</li>
                    </ol>
                </nav>
